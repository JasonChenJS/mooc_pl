use "hw3.sml";
(* thanks to https://www.coursera.org/learn/programming-languages/discussions/all/threads/DA4fpBk2EeevPg7X4ZMqyg
for the clarification of the last 2 problems *)
